...
model=open('{caminho do arquivo}/gaia_previsao_chuva.pkl','rb')
 
client = pymongo.MongoClient('import pymongo')
 
helper_module = imp.load_source('*', '{caminho do arquivo}/helper.py')
model = NLPModel()

client = pymongo.MongoClient("mongodb+srv://spaceapps:<password>@cluster0-jf6fr.mongodb.net/test?retryWrites=true&w=majority") 
db = client.ContactDB
